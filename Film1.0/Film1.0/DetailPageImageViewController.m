...
-(void)Initial{
    ...
    UIImageView *img1=[[UIImageView alloc]initWithFrame:CGRectMake(0, 0, 400, 350)];
    img1.image=[UIImage imageNamed:@"gangjiong@2x.jpg"];
    UIImageView *img3=[[UIImageView alloc]initWithFrame:CGRectMake(0, 350, 200, 120)];
    img3.image=[UIImage imageNamed:@"jiehun@2x.jpg"];
    UIImageView *img4=[[UIImageView alloc]initWithFrame:CGRectMake(200, 350, 200, 120)];
    img4.image=[UIImage imageNamed:@"tegong@2x.jpg"];
    UIImageView *img5=[[UIImageView alloc]initWithFrame:CGRectMake(0, 470, 133, 80)];
    img5.image=[UIImage imageNamed:@"titans@2x.jpg"];
    UIImageView *img6=[[UIImageView alloc]initWithFrame:CGRectMake(133, 470, 134, 80)];
    img6.image=[UIImage imageNamed:@"zhanlang@2x.jpg"];
    UIImageView *img7=[[UIImageView alloc]initWithFrame:CGRectMake(267, 470, 400, 80)];
    img7.image=[UIImage imageNamed:@"zhuiai@2x.jpg"];
    UIImageView *img8=[[UIImageView alloc]initWithFrame:CGRectMake(0, 550, 200, 120)];
    img8.image=[UIImage imageNamed:@"gangjiong@2x.jpg"];
    UIImageView *img9=[[UIImageView alloc]initWithFrame:CGRectMake(200, 550, 200, 120)];
    img9.image=[UIImage imageNamed:@"gangjiong@2x.jpg"];
    UIImageView *img10=[[UIImageView alloc]initWithFrame:CGRectMake(0, 670, 400, 65)];
    img10.image=[UIImage imageNamed:@"gangjiong@2x.jpg"];
    UIImageView *img11=[[UIImageView alloc]initWithFrame:CGRectMake(100, 670, 400, 65)];
    img11.image=[UIImage imageNamed:@"gangjiong@2x.jpg"];
    UIImageView *img12=[[UIImageView alloc]initWithFrame:CGRectMake(200, 670, 400, 65)];
    img12.image=[UIImage imageNamed:@"gangjiong@2x.jpg"];
    UIImageView *img2=[[UIImageView alloc]initWithFrame:CGRectMake(300, 670, 400, 65)];
